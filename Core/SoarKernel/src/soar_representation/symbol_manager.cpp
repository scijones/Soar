...
void Symbol_Manager::create_predefined_symbols()
{
    ...
    soarSymbols.epmem_sym_interval_query = make_str_constant("interval-query");
    soarSymbols.epmem_sym_interval_relation = make_str_constant("interval-relation");
    soarSymbols.epmem_sym_left = make_str_constant("left");
    soarSymbols.epmem_sym_right = make_str_constant("right");
    soarSymbols.epmem_sym_type = make_str_constant("type");
    ...
    soarSymbols.smem_sym_depth = make_str_constant("target");
    soarSymbols.smem_sym_depth = make_str_constant("candidate");
...
void Symbol_Manager::release_predefined_symbols()
{
    ...
    symbol_remove_ref(&(soarSymbols.epmem_sym_interval_query));
    symbol_remove_ref(&(soarSymbols.epmem_sym_interval_relation));
    symbol_remove_ref(&(soarSymbols.epmem_sym_left));
    symbol_remove_ref(&(soarSymbols.epmem_sym_right));
    symbol_remove_ref(&(soarSymbols.epmem_sym_type));
    ...
    symbol_remove_ref(&(soarSymbols.smem_sym_target));
    symbol_remove_ref(&(soarSymbols.smem_sym_candidate));
