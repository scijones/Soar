...
void Symbol_Manager::create_predefined_symbols()
{
    ...
    soarSymbols.epmem_sym_addition = make_str_constant("addition");
    soarSymbols.epmem_sym_addition_constant = make_str_constant("constant-addition");
    soarSymbols.epmem_sym_addition_constant_parent = make_str_constant("parent");
    soarSymbols.epmem_sym_addition_constant_attribute = make_str_constant("attribute");
    soarSymbols.epmem_sym_addition_constant_value = make_str_constant("value");
    soarSymbols.epmem_sym_removal_constant = make_str_constant("constant-removal");
    soarSymbols.epmem_sym_removal_constant_parent = make_str_constant("parent");
    soarSymbols.epmem_sym_removal_constant_attribute = make_str_constant("attribute");
    soarSymbols.epmem_sym_removal_constant_value = make_str_constant("value");
    soarSymbols.epmem_sym_removal = make_str_constant("removal");
    ...
    soarSymbols.epmem_sym_segment = make_str_constant("segment");
...
void Symbol_Manager::release_predefined_symbols()
{
    ...
    symbol_remove_ref(&(soarSymbols.epmem_sym_addition));
    symbol_remove_ref(&(soarSymbols.epmem_sym_addition_constant));
    symbol_remove_ref(&(soarSymbols.epmem_sym_addition_constant_parent));
    symbol_remove_ref(&(soarSymbols.epmem_sym_addition_constant_attribute));
    symbol_remove_ref(&(soarSymbols.epmem_sym_addition_constant_value));
    symbol_remove_ref(&(soarSymbols.epmem_sym_removal));
    symbol_remove_ref(&(soarSymbols.epmem_sym_removal_constant));
    symbol_remove_ref(&(soarSymbols.epmem_sym_removal_constant_parent));
    symbol_remove_ref(&(soarSymbols.epmem_sym_removal_constant_attribute));
    symbol_remove_ref(&(soarSymbols.epmem_sym_removal_constant_value));
    ...
    symbol_remove_ref(&(soarSymbols.epmem_sym_segment));
