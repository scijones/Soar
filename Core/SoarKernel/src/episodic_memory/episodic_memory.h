...
class epmem_graph_statement_container: public soar_module::sqlite_statement_container
{
    public:
        ...
        soar_module::sqlite_statement* get_lti_id_for_w_id;
        ...
        soar_module::sqlite_statement* delete_temp_parent_cache;
        ...
        soar_module::sqlite_statement* find_epmem_wmes;
        soar_module::sqlite_statement* find_w_id_info;
